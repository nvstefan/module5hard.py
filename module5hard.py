...
class Video:
    """
    Класс видео, содержащий параметры видео контента
    """
...
class UrTube:
    """
    Класс, обрабатывающий все данные для получения необходимого результата
    """
    def __init__(self):
        self.users = []
        self.videos = []
    ...
    def register(self, nickname: str, password: str, age: int):
        ...
        print(f'{nickname}, Вы успешно зарегистрированы')
